...
-- object: public."many_Team_table_has_many_local_of_the_games_table" | type: TABLE --
-- DROP TABLE IF EXISTS public."many_Team_table_has_many_local_of_the_games_table" CASCADE;
CREATE TABLE public."many_Team_table_has_many_local_of_the_games_table"(
	"team_id_Team_table" bigint NOT NULL,
...
-- object: "Team_table_fk" | type: CONSTRAINT --
-- ALTER TABLE public."many_Team_table_has_many_local_of_the_games_table" DROP CONSTRAINT IF EXISTS "Team_table_fk" CASCADE;
ALTER TABLE public."many_Team_table_has_many_local_of_the_games_table" ADD CONSTRAINT "Team_table_fk" FOREIGN KEY ("team_id_Team_table")
REFERENCES public."Team_table" (team_id) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: local_of_the_games_table_fk | type: CONSTRAINT --
-- ALTER TABLE public."many_Team_table_has_many_local_of_the_games_table" DROP CONSTRAINT IF EXISTS local_of_the_games_table_fk CASCADE;
ALTER TABLE public."many_Team_table_has_many_local_of_the_games_table" ADD CONSTRAINT local_of_the_games_table_fk FOREIGN KEY (local_id_local_of_the_games_table)
